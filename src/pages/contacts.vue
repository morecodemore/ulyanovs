<template>
  <main class="contacts">
    <app-logo></app-logo>
    <h1 class="head-title" v-lang.contact.title></h1>
    <div class="link">
      <a class="social email" href="mailto:myemail@gmail.com?subject=Вопрос со страницы портфолио">myemail@gmail.com</a>
...
<style lang="scss" scoped>
  ...
  .email {
    ...
    animation: text-block 1.2s ease-in-out;
  }
  ...
  .inst {
    padding: 30px;
    animation: text-block 1.5s ease-in-out;
  }
